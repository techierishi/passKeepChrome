...
/* const dropboxAccessToken = Util.parseQueryString(window.location.hash).access_token;
console.log('dropboxAccessToken', dropboxAccessToken);
chrome.runtime.sendMessage({ type: 'dropboxConnectToken', content: dropboxAccessToken });
