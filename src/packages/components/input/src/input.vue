...
<div class="mt-input-group clearfix" :class="{
    ...
    <div class="mt-input-line" :class="{'mt-input-focus': focused,'mt-input-have': isFlag && haveText}">
        <input type="text" class="mt-input" v-bind="$props" :placeholder="placeholderText" @blur="handleBlur" @focus="handleFocus" @input="handleInput" @change="handleChange" v-model="currentValue">
