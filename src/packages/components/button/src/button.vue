...
<button class="mt-button" @click="handleClick" @mousedown.left="shadowFadeIn" @touch="handleClick" @touchstart="shadowFadeIn" @touchend="shadowFadeOut" v-bind="$props" :class="{
      [`mt-button-${size}`]: size,
    ...
    <span class="mt-button-shadow" :style="{
        top: `${shadowTop}px`,
        left: `${shadowLeft}px`,
